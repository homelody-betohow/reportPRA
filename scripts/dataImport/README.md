...
- 数据库连接：`database/db_connection.py`、`config/db_config.json`
- 汇率配置：`config/common.py`
- 表结构：`docs/database/` 下 `sales_order_*.sql`、`030_temu_order_detail.sql`、`002_product_sku_mapping.sql`
